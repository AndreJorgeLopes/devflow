---
description: [0.11.1] Use when starting a new initiative spike, investigating technical feasibility, assessing impact across services, or writing an engineering discovery document — produces a structured spike doc with diagrams and a private notes file.
---
...
First arg = project-tracker ticket ID (optional). Everything after = free-text context.
