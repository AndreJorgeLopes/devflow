---
description: [0.17.3] Recall relevant memories from Hindsight before starting a task. Injects past learnings, decisions, and context into the current session.
---
