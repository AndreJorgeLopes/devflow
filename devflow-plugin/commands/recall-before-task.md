---
description: [0.15.0] Recall relevant memories from Hindsight before starting a task. Injects past learnings, decisions, and context into the current session.
---
