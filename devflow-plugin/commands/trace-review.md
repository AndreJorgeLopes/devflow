---
description: [0.15.1] Use when asked to review skill telemetry, find week-over-week skill regressions, run a weekly Langfuse trace report, or check whether a skill got slower / more expensive / more error-prone - produces a per-skill regression report from the local Langfuse trace store and can schedule itself.
---
